...
CREATE or replace TABLE part (
    dw_part_shk         BINARY (40) not null,  -- Example data type, adjust as needed
    dw_hash_diff        BINARY (40) not null,  -- Example data type, adjust as needed
    dw_version_ts       TIMESTAMP not null,    -- Example data type, adjust as needed
    p_partkey           INT not null,          -- Example data type, adjust as needed
    p_name              VARCHAR(255) not null, -- Example data type, adjust as needed
    p_mfgr              VARCHAR(50) not null,  -- Example data type, adjust as needed
    p_brand             VARCHAR(50) not null,  -- Example data type, adjust as needed
    p_type              VARCHAR(50) not null,  -- Example data type, adjust as needed
    p_size              INT not null,          -- Example data type, adjust as needed
    p_container         VARCHAR(50) not null,  -- Example data type, adjust as needed
    p_retailprice       DECIMAL(10, 2) not null, -- Example data type, adjust as needed
    p_comment           VARCHAR(1000) not null, -- Example data type, adjust as needed
    last_modified_dt    TIMESTAMP not null,    -- Example data type, adjust as needed
    dw_file_name        VARCHAR(255) not null, -- Example data type, adjust as needed
    dw_file_row_no      INT not null,          -- Example data type, adjust as needed
    dw_load_ts          TIMESTAMP not null,    
    dw_update_ts        TIMESTAMP not null    -- Example data type, adjust as needed
);
